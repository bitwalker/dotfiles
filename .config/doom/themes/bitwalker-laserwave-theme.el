;;; bitwalker-laserwave-theme.el --- inspired by VS Code laserwave
(require 'doom-themes)

;;
(defgroup bitwalker-laserwave-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom bitwalker-laserwave-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'bitwalker-laserwave-theme
  :type '(choice integer boolean))

;;
(def-doom-theme bitwalker-laserwave
  ...
  ((bg         '("#27212E" nil       nil            ))
   ...
   (-modeline-pad
    (when bitwalker-laserwave-padded-modeline
      (if (integerp bitwalker-laserwave-padded-modeline) bitwalker-laserwave-padded-modeline 4)))
...
;;; bitwalker-laserwave-theme.el ends here
