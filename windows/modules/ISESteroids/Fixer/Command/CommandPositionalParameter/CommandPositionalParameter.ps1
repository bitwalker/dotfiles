				...
				foreach($parameter in ($set.Parameters | Sort-Object -Property Position))
				{
					...
					if ($position -ge 0)
					{
						...
						else
						{
							...
							if ($positionalparameters.ContainsKey($realposition))
							{
								...
								if ($skip -eq $false)
								{
									...
									{
										$changes += 1
										$changes[$changes.Count-1] = @($positionalparameters[$realposition].Extent.StartOffset, $positionalparameters[$realposition].Extent.StartOffset, (' -'+ $parameter.Name + ' ')) 
									}
								}
							}
						}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlerFT8J9yOmJuZls+JS7Zwd7
# uC6gghkGMIIFHDCCBASgAwIBAgIQAp+oNhrWxpP858ywp8f2ezANBgkqhkiG9w0B
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCxc
# fCdaK3R1ogqlBmGrq77Fn8taMA0GCSqGSIb3DQEBAQUABIIBAFkpvp8/CjkWA/iM
# 3RB4f+uF6qh7EDLGLKnQCyTx2YlKG3kYkGG0YuWTwMZPClx6/8/0ilIGczFti2ST
# EnBPrmZfGKQTUhmU5UCY56ihNK8PyU5Ob030ufkTKNOipOB2tVUQvalGj2u0i0Db
# F1J6FyD2iS8E7T4DYeWMYzc0kFfHIziSe7GPUS6ksi/jsuEnBFNAIH9/xeX2D1qO
# zQ844t3Cz/lWpm4LrnXu+vSCLEYNG5yLaGsZvazB1KR9QKwcEgx6uTmTGRanMiIe
# RWQ4Aesw6cQA+rL2yiChbEN19wyGxdREgrj1IXnw/baf+bTu+7OEyROqKYJ5oIjj
# d/hXc3KhggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgCAQEwdjBiMQswCQYDVQQG
...
# FPoTlS896N6J9lr5sQ4GdNd+zXXVMA0GCSqGSIb3DQEBAQUABIIBADNuL2z2Oz/s
# k0V+srDJBVvSwSNcZPS6hdP8LvTY4swUpSAcDecVwso9JN9Nq15KscB34NS5HLig
# CWcDqU8cbwhKIae07gl3IjXKq2LVdz/UfvmbxV4DDusabhy1rWsM+AnWBtf1jvqN
# ougg2hHbRkEfygyOWlDHkG/PJlgatHENPxVyNq8kCxnAIX+Dh4pLcwgmTi1ay5bP
# HTzFaudcqzj9Kbj7IxdyerFOwTOYmnkAUnmroKpH3Vh+04Phpx9F9V4EQSQ5924I
# FxAflIRbPzOIJE7o58HPV2pwI3yewWoUTFTTnmSxBIJj0cpG7boYTVRtuwtouyqK
# Pmp+2MXpRMM=
