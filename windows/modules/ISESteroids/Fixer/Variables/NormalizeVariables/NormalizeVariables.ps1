& {
	...
	foreach($variable in $variables)
	{
		...
		if ($lookup.ContainsKey($name))
		{
			...
			{ Add-SteroidsTextChange -PositionInfo $variable.Extent -ReplacementText $lookup[$name] }
		}
		else
		{
			$lookup.Add($name, $variable.Extent.Text)
		}
	}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjW/o5+HHO8r09jXYkGAapAol
# J3CgghkGMIIFHDCCBASgAwIBAgIQAp+oNhrWxpP858ywp8f2ezANBgkqhkiG9w0B
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKjH
# P9JgfzWpj6+VWqvjsSAo6noZMA0GCSqGSIb3DQEBAQUABIIBAISuO2lxhvMalEnM
# jrcXEeyd2HrQ9ObUCXjUCffEv4HdmPUjawVk3y3UR8UcnCTaa1BrU8UtD3EglevL
# NsEWmlKN3blWXQKohFZOf10O7nZc+3hUJucq4x+mWt4s/xfQh3Zb6uTRPqVWJsmG
# I5+6KwxguDeiCcmnqIFk4CyYIaCvLC/qO5M6yg17lU5uutx2i6CPmzKlSZySlyHc
# s6cVPxjbWGdycZPg+ptWs3oT7OAVE21QUZCX+5+hS/9DtaqjzJ2gQ+vw8sGkuJhL
# dzJPajMxsWh9b4NV3lOZYuU92qNgdrA1dKya4nwccp3EjBGGqc9kaQ2PNwPjZxZw
# AEUicwehggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgCAQEwdjBiMQswCQYDVQQG
...
# BwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTAyNTExMzEyOVowIwYJKoZIhvcNAQkEMRYE
# FBvli3NxoSYWlmf52UL4eLxry6DDMA0GCSqGSIb3DQEBAQUABIIBAD5pkOxeIptc
# L3T1Ld+3BhRz2W3Wf+i1VVuhEvx0UysnppKPkYvf3fo1HLG5J5ZnXUgc9XE9ner+
# bySEGFr6hYieKC/nbz5CX4+HuwIhpmdOYzaljzcKB3LWp+J6CHcN4EA/GOOjga2y
# Dq5uBp4tmkwLDujVHsVlRrgX75/Xk1kmRYFsOQMzUS0UKFzF2SPVJC1zi7nL3kfr
# iJFz0ljMh5lzBEzQ+8QTE03oQDduVH4HDCMEKUGxft8iLHOouT3eBqBi35x1lcDa
# vWEo3B6MAUCznPDPsqlJcahNY9g6HKg9TTGJA0T/5TA6KKqtL3OrgcH87l3oeMiy
# pUX38UMX8xY=
