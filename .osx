...
sudo scutil --set ComputerName "Revenant"
sudo scutil --set HostName "Revenant"
sudo scutil --set LocalHostName "Revenant"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Revenant"
...
open "${HOME}/init/Monokai Soda.itermcolors"

# Load visor profile
cp "${HOME}/init/com.googlecode.iterm2.plist" ~/Library/Prefrences/com.googlecode.iterm2.plist
